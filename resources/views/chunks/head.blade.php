<head>
    ...
    <meta name="csrf-token" content="xxx{{ csrf_token() }}">
   ...
   @theme
    ...
    <!-- config -->
    <script>var AWEMA_CONFIG = @json(array_merge_recursive(config('indigo-layout.frontend'), [
        'lang' => app(\Illuminate\Contracts\Translation\Translator::class)->get('indigo-layout::js')
    ], (isset($awema_custom_config) ? $awema_custom_config : [])))
    </script>
