(function () {
        ...
        methods: {
            ...
            copy() {
                ...
                try {
                    ...
                    t.select();
                    d.execCommand('copy');
                    AWEMA.notify({ message: AWEMA.lang.CODE_COPIED_MSG });
                } catch (e) {
                    AWEMA.notify({ status: 'error', message: e.message });
                } finally {
    ...
    var __vue_render__$1 = function() {
      ...
      var _h = _vm.$createElement;
      var _c = _vm._self._c || _h;
      return _c("pre", { attrs: { "data-language": _vm.language } }, [
        _c(
          "button",
          { staticClass: "hljs-copy has-wave", on: { click: _vm.copy } },
          [_vm._v(_vm._s(_vm.$lang.CODE_COPY)), _c("span", { staticClass: "wave" })]
        ),
        _c("code", { pre: true }, [_vm._t("default")], 2)
      ])
    };
    ...
    function install() {
        ...
        Vue.prototype.$awemaLayoutCrm = new Vue(layoutApp);
